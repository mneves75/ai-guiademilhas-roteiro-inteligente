...
export const GET = withApiLogging('api.og', async (request: NextRequest) => {
  ...
  const title = cleanText(searchParams.get('title') ?? 'Guia de Milhas', 120);
  const description = cleanText(
    searchParams.get('description') ?? 'Planejamento inteligente de viagens com milhas',
    240
  );
  ...
  return new ImageResponse(
    ...
    >
      ...
      >
        <span style={{ fontSize: '24px', color: '#71717a' }}>guiademilhas.com</span>
      </div>
